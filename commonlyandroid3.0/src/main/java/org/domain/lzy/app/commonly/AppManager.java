...
public final class AppManager {
    ...
    /**
     * 让在前台的 {@link Activity},使用 {@link android.support.design.widget.Snackbar} 显示文本内容
     * @param message
     * @param isLong
     */
     ...
     * 如当后台 {@link Service} 执行某个任务时, 需要让前台 {@link Activity} ,做出某种响应操作或其他操作,如弹出 {@link android.app.Dialog}, 这时在 {@link Service} 中就可以使用 {@link #getCurrentActivity()}
     * 如果返回为 {@code null}, 说明没有前台 {@link Activity} (用户返回桌面或者打开了其他 App 会出现此状况), 则不做任何操作, 不为 {@code null}, 则弹出 {@link android.app.Dialog}
     *
     * @return
     */
